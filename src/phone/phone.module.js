...
exports.PhoneModule = PhoneModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([phone_entity_1.Phone]), // This registers PhoneRepository in the module
        ],
        providers: [phone_service_1.PhoneService],
        controllers: [phone_controller_1.PhoneController],
        exports: [phone_service_1.PhoneService], // Export if other modules need PhoneService
    })
], PhoneModule);
